...
@section('title', 'Doacao - ' . $configuracao->nome_paroquia)

@section('content')
    <main class="page page-public">
        <header class="header">
            <h1 class="title">Como doar</h1>
            <p class="subtitle">Dados oficiais para doacao na {{ $configuracao->nome_paroquia }}.</p>
        </header>

        <section class="form-grid-two">
            <article class="card">
                <h2 class="section-title">Endereco</h2>
                <p class="subtitle">{{ $configuracao->endereco ?: 'Endereco nao informado.' }}</p>
            ...
            <article class="card">
                ...
                <p id="copyHint" class="copy-hint">Use o botao para copiar.</p>
            </article>
        </section>

        <section class="card mt-16">
            <h2 class="section-title">Precisa de ajuda?</h2>
            <p class="subtitle">Se voce precisa receber itens, abra um pedido publico para atendimento da equipe.</p>
    ...
    <script>
        ...
        button?.addEventListener('click', async () => {
            ...
            try {
                ...
                hint.textContent = 'Nao foi possivel copiar automaticamente.';
            }
        });
    </script>
@endpush
